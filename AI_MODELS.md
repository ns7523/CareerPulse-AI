# AI Models in CareerPulse AI

CareerPulse AI uses advanced AI models to provide detailed analysis and feedback on your resume. This document explains the AI models integrated into the application and how they work.

## Available AI Models

### 1. Google Gemini

Google Gemini is a powerful AI model developed by Google that offers state-of-the-art natural language processing capabilities. In CareerPulse AI, Gemini is used to:
